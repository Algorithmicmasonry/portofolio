...
const MagicButton = ({title, icon, position, handleClick, otherClasses}: {
  ...
  return (
    <button className="relative inline-flex h-12 overflow-hidden w-full rounded-lg p-[1px] focus:outline-none md:w-60 md:mt-10 line-clamp-1" onClick={handleClick}>
