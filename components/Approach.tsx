  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        ...
        <Card title="Development & Launch" icon={<AceternityIcon order="Phase 3"/>} description="This is where the magic happens! Based on the approved design, i'll translate everything into functional code, building your webstie from the ground up.">
          <CanvasRevealEffect
            animationSpeed={3}
